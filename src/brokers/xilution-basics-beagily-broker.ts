...
export const buildListThingsUrl = (
  env: string,
  type: string,
  pageNumber: number,
  pageSize: number
...
export const buildDeleteThingUrl = (
  env: string,
  type: string,
  thingId: string
) =>
...
export const updateType = async (
  ...
  axios.put(buildUpdateTypeUrl(env, name), type, {
    headers: {
...
export const deleteType = async (
  ...
  axios.delete(buildDeleteTypeUrl(env, name), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const getType = async (
  ...
  axios.get(buildGetTypeUrl(env, name), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const listThings = async (
  ...
  axios.get(buildListThingsUrl(env, type, pageNumber, pageSize), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const createThing = async (
  ...
  axios.post(buildPostThingUrl(env, type), thing, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const updateThing = async (
  ...
  axios.put(buildPutThingUrl(env, type, thingId), thing, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const getThing = async (
  ...
  axios.get(buildGetThingUrl(env, type, thingId), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const deleteThing = async (
  ...
  axios.delete(buildDeleteThingUrl(env, type, thingId), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
