...
export const buildListTweetsUrl = (
  env: string,
  pageNumber: number,
  pageSize: number
) =>
...
export const buildListTweetEventsUrl = (
  env: string,
  pageNumber: number,
  pageSize: number,
...
export const buildAuditScheduledTweetsUrl = (
  env: string,
  pageNumber: number,
  pageSize: number,
  fromTimestamp: string,
...
export const buildListScheduledTweetsUrl = (
  env: string,
  pageNumber: number,
  pageSize: number,
  fromTimestamp: string,
...
export const buildPutScheduledTweetUrl = (
  env: string,
  scheduledTweetId: string
) =>
  `https://${env}.chickadee.social.api.xilution.com/scheduled-tweets/${scheduledTweetId}`;

export const buildGetScheduledTweetUrl = (
  env: string,
  scheduledTweetId: string
) =>
  `https://${env}.chickadee.social.api.xilution.com/scheduled-tweets/${scheduledTweetId}`;

export const buildDeleteScheduledTweetUrl = (
  env: string,
  scheduledTweetId: string
) =>
  `https://${env}.chickadee.social.api.xilution.com/scheduled-tweets/${scheduledTweetId}`;

export const buildListTwitterAccountsUrl = (
  env: string,
  pageNumber: number,
  pageSize: number
) =>
...
export const buildPutTwitterAccountUrl = (
  env: string,
  twitterAccountId: string
) =>
  `https://${env}.chickadee.social.api.xilution.com/twitter-accounts/${twitterAccountId}`;

export const buildGetTwitterAccountUrl = (
  env: string,
  twitterAccountId: string
) =>
  `https://${env}.chickadee.social.api.xilution.com/twitter-accounts/${twitterAccountId}`;

export const buildDeleteTwitterAccountUrl = (
  env: string,
  twitterAccountId: string
) =>
  `https://${env}.chickadee.social.api.xilution.com/twitter-accounts/${twitterAccountId}`;
...
export const listTweets = async (
  ...
  axios.get(buildListTweetsUrl(env, pageNumber, pageSize), {
    headers: {
...
export const createTweet = async (
  ...
  axios.post(buildPostTweetUrl(env), tweet, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const updateTweet = async (
  ...
  axios.put(buildPutTweetUrl(env, tweetId), tweet, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const getTweet = async (
  ...
  axios.get(buildGetTweetUrl(env, tweetId), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const deleteTweet = async (
  ...
  axios.delete(buildDeleteTweetUrl(env, tweetId), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const getTweetEvent = async (
  ...
  axios.get(buildGetTweetEventUrl(env, tweetEventId), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const createScheduledTweet = async (
  ...
  axios.post(buildPostScheduledTweetUrl(env), scheduledTweet, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const updateScheduledTweet = async (
  ...
  axios.put(buildPutScheduledTweetUrl(env, scheduledTweetId), scheduledTweet, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const getScheduledTweet = async (
  ...
  axios.get(buildGetScheduledTweetUrl(env, scheduledTweetId), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const deleteScheduledTweet = async (
  ...
  axios.delete(buildDeleteScheduledTweetUrl(env, scheduledTweetId), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const listTwitterAccounts = async (
  ...
  axios.get(buildListTwitterAccountsUrl(env, pageNumber, pageSize), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const createTwitterAccount = async (
  ...
  axios.post(buildPostTwitterAccountUrl(env), twitterAccount, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const updateTwitterAccount = async (
  ...
  axios.put(buildPutTwitterAccountUrl(env, twitterAccountId), twitterAccount, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const getTwitterAccount = async (
  ...
  axios.get(buildGetTwitterAccountUrl(env, twitterAccountId), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
...
export const deleteTwitterAccount = async (
  ...
  axios.delete(buildDeleteTwitterAccountUrl(env, twitterAccountId), {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
    validateStatus: () => true,
